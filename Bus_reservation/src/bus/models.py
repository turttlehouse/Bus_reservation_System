...
class BusInfo(models.Model):
    ...
    arriving_from = models.ForeignKey(BusPickArea, on_delete=models.CASCADE)  # Specify on_delete parameter
    depature_at = models.ForeignKey(BusDropArea, on_delete=models.CASCADE) 
